...
# ─────────────────────────────────────────────────────────────────────────────
# FEATURE ENGINEERING — THE FIX IS HERE
...
def build_model_input(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # ── FIXED COLUMN ORDER ─────────────────────────────
    # This precisely matches what is inside your scaler.pkl memory.
    FIT_COLUMNS = [
        "Pregnancies",
        "Glucose",
        "BloodPressure",
        ...
        "Age",
        "Insulin_Glucose_Ratio",  # This must be 9th
        "BMI_Class",              # This must be 10th
        "Age_Glucose",            # This must be 11th
    ]
